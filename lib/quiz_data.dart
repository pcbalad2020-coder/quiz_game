// ============================================================
// 📚 ملف بيانات الأسئلة - quiz_data.dart
// يحتوي على جميع المراحل والأسئلة (150+ سؤال / 10 مراحل)
// كل مرحلة: 15 سؤالاً بـ 4 خيارات وإجابة صحيحة واحدة
// ============================================================
...
class QuizData {
  static const List<QuizLevel> levels = [
    // ══════════════════════════════════════════════
    // 🔬 المرحلة 1 — العلوم العامة (15 سؤال)
    // ══════════════════════════════════════════════
    QuizLevel(
      id: 1,
      title: 'العلوم العامة',
    ...
    QuizLevel(
      ...
      questions: [
        QuizQuestion(
          ...
          options: ['9', '10', '11', '12'],
          correctIndex: 2,
          explanation: 'كل فريق يتكون من 11 لاععباً أساسياً على أرض الملعب.',
        ),
        QuizQuestion(
    ...
    // ══════════════════════════════════════════════
    // 🌿 المرحلة 6 — عالم الطبيعة (15 سؤال)
    // ══════════════════════════════════════════════
    QuizLevel(
      id: 6,
      title: 'عالم الطبيعة',
    ...
    // ══════════════════════════════════════════════
    // 🎨 المرحلة 8 — الفن والثقافة (15 سؤال)
    // ══════════════════════════════════════════════
    QuizLevel(
      id: 8,
      title: 'الفن والثقافة',
    ...
    // ══════════════════════════════════════════════
    // 👑 المرحلة 10 — التحدي الأخير (15 سؤال)
    // ══════════════════════════════════════════════
    QuizLevel(
      id: 10,
      title: 'التحدي الأخير',
